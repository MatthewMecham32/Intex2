...
namespace justTesting.Models
{
    public class IdentitySeedData
    {
                ...
                serviceProvider, IConfiguration configuration)
        {
            ...
            string username = configuration["Data:AdminUser:Name"] ?? "Kerry";
            string email
                = configuration["Data:AdminUser:Email"] ?? "kerry@example.com";
            string password = configuration["Data:AdminUser:Password"] ?? "Fag-elGamous";
